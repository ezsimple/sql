CREATE PROCEDURE  `SP_STATS_GAME_MIN18_STROKE_SCORE`(
IN $GM_CODE CHAR(13),
IN $MODE VARCHAR(20)
)
BEGIN
  ...
  IF $MODE is NULL THEN
    ...
    AND STATS_DIV = '18HOLE_MIN_STROKE';
  ...
  ELSEIF $MODE = 'GEN' THEN
    BEGIN
      ...
      SELECT $GM_CODE, MM_CODE, '18HOLE_MIN_STROKE',MM_NAME_DISPLAY, E_MM_NAME_DISPLAY, SUM_STROKE
